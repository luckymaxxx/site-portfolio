...
bioShort: 'Full-stack інженер, який веде задачу крізь усі шари — від схеми бази й фонових воркерів до React-екранів і мобільного застосунку. Останні роки будую **B2B-продукти на TypeScript**: планування маршрутів у реальному часі, білінг і платежі, синхронізація з чужими API. Щодня працюю з кодовими агентами — Claude Code і Cursor — і налаштовую їх під проект: власні скіли, правила репозиторію, MCP.'
...
skills:
  ...
  - group: 'AI у розробці'
    items:
      ...
      - { name: 'MCP-сервери', key: true }
      - { name: 'власні скіли для агентів', key: true }
      - { name: 'rules та інструкції проекту', key: true }
...
experience:
  - company: 'Noble.codes'
    ...
    bullets:
      - 'Один із двох ключових інженерів платформи: вів продуктові напрямки наскрізно — від схеми бази й фонових процесів до вебінтерфейсу та мобільного застосунку.'
      - 'Уніфікував створення й редагування записів, замінивши розсипані legacy-діалоги єдиною системою покрокових форм.'
      - 'Побудував шлях від комерційної пропозиції до платного клієнта: онлайн-схвалення, оплата, автоматична конвертація.'
      - 'Зробив планування й диспетчеризацію в реальному часі поверх черги фонових задач.'
      - 'Автоматизував виставлення рахунків і регулярні списання, стабілізував зовнішню бухгалтерську інтеграцію під навантаженням.'
    project: 'field-service-platform'
  - company: 'Noble.codes'
    role: 'Full-Stack Engineer'
    period: 'червень 2026 - серпень 2026'
    bullets:
      - 'Закрив наскрізний напрямок: двосторонню синхронізацію контенту між платформою і зовнішніми системами, де цей контент живе.'
      - 'Спроєктував модель даних і єдину точку запису, щоб стан з обох боків не розходився непомітно.'
      - 'Реалізував виявлення розходжень і ручне розв’язання конфліктів замість тихого перезапису чужих змін.'
      - 'Написав конвертери текстових форматів із компіляцією у WebAssembly й покрив їх тестами на реальних даних.'
      - 'Узагальнив автентифікацію інтеграцій, щоб додавати нові джерела без окремого сховища секретів.'
    project: 'ai-search-platform'
  - company: 'Eleks'
    ...
    project: 'Інструмент керування даними дата-центру'
  - company: 'Eleks'
    ...
    project: 'Дашборд аналітики продуктивності'
  - company: 'Eleks'
    role: 'Backend Developer'
    period: '3 місяці'
    ...
    project: 'Консольна гра (pet-проект)'
...
description: 'Максим Ситків — full-stack інженер зі Львова: TypeScript, React, Node. Будую B2B-продукти наскрізно — від схеми бази даних до мобільного застосунку.'
